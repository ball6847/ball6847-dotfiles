...
files="profile bashrc vimrc zshrc bang tmux.conf eslintrc.json pip/pip.conf config/terminator/config ansible.cfg"    # list of files/folders to symlink in homedir
