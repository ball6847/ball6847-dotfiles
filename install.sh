...
files="profile bashrc vimrc zshrc bang tmux.conf eslintrc.json pip/pip.conf config/terminator/config ansible.cfg coffeelint.json"    # list of files/folders to symlink in homedir
