...
Write-Host "This will disable auto-update but keep all script files.`n" -ForegroundColor Gray
...
if ($removed) {
    ...
    Write-Host "`nAll script files have been preserved in your dotfiles directory:" -ForegroundColor Gray
    Write-Host "  - auto-update.ps1" -ForegroundColor Gray
    Write-Host "  - auto-update.sh" -ForegroundColor Gray
    Write-Host "  - setup-auto-update.ps1" -ForegroundColor Gray
    Write-Host "  - uninstall-auto-update.ps1" -ForegroundColor Gray
    Write-Host "`nTo re-enable auto-update, run: setup-auto-update.ps1" -ForegroundColor Cyan
} else {
...
Write-Host "`nUninstall completed!" -ForegroundColor Cyan
