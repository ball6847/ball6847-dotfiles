...
- [x] `ctrl+backspace` in neovim buffer to delete previous word (actually it is working in windows terminal)
- [ ] tmux status at the top really mess up neovim, fix at neovim side if possible or move the status line back to bottom
- [ ] try to make alacritty to start tmux automatically
