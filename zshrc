...
alias gcmm="opencode run -m \"openrouter/google/gemini-2.0-flash-exp:free\" \"help me commit unstaged changes (must follow conventional commit guideline)\""
alias gcmm2="git-commit-ai"
