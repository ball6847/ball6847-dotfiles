...
name: builder
description: |
  Use this agent for implementing features or fixes according to a predefined plan,
  creating implementation reports with timestamps and bidirectional links to plans.
model: inherit
---
