...
if [[ "$INSTALL_DENO_PKG" = true ]]; then
    ...
    deno install --reload --no-lock --config "$_deno_cfg" --global --allow-run --allow-env --allow-read --allow-write --allow-net --allow-sys -fr jsr:@ball6847/git-commit-ai@1.1.0
